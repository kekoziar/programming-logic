...
but, I want to share that I've been programming for a long time, and have done all of the math, and I \emph{still} will have to double-check that the index I'm referring to in multidimensional arrays or matrices is listed in the correct order.
