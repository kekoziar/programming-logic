...
\begin{Shaded}
\begin{Highlighting}[numbers=left,,]
\KeywordTok{function} \VariableTok{assignment01\_leaf}
\CommentTok{\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\% (C) Student Name Here \%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%}
\VariableTok{TRAIN} \OperatorTok{=} \VariableTok{load}\NormalTok{(}\SpecialStringTok{\textquotesingle{}FaultsNNA\_csv\textquotesingle{}}\NormalTok{)}\OperatorTok{;} \CommentTok{\% Only these two lines need to be changed to test a different dataset. \% }
\CommentTok{\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%}

\VariableTok{TRAIN\_class\_labels} \OperatorTok{=} \VariableTok{TRAIN}\NormalTok{(}\OperatorTok{:,}\FloatTok{1}\NormalTok{)}\OperatorTok{;}    \CommentTok{\% Pull out the class labels.}
\VariableTok{TRAIN}\NormalTok{(}\OperatorTok{:,}\FloatTok{1}\NormalTok{) }\OperatorTok{=}\NormalTok{ []}\OperatorTok{;}    \CommentTok{\% Remove class labels from training set.}

\CommentTok{\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%}
\CommentTok{\% Compute and display Default Rate and other Basic Information}
\CommentTok{\%}
\NormalTok{[}\VariableTok{class}\OperatorTok{,}\VariableTok{count}\NormalTok{] }\OperatorTok{=} \VariableTok{mode}\NormalTok{(}\VariableTok{TRAIN\_class\_labels}\NormalTok{(}\OperatorTok{:,}\FloatTok{1}\NormalTok{))}\OperatorTok{;}
\VariableTok{default\_error\_rate}\OperatorTok{=}\FloatTok{1}\OperatorTok{{-}}\NormalTok{(}\VariableTok{count}\OperatorTok{/}\VariableTok{size}\NormalTok{(}\VariableTok{TRAIN\_class\_labels}\NormalTok{(}\OperatorTok{:,}\FloatTok{1}\NormalTok{)}\OperatorTok{,}\FloatTok{1}\NormalTok{))}\OperatorTok{;}
\VariableTok{disp}\NormalTok{([}\SpecialStringTok{\textquotesingle{}The dataset you tested has \textquotesingle{}}\OperatorTok{,} \VariableTok{int2str}\NormalTok{(}\VariableTok{length}\NormalTok{(}\VariableTok{unique}\NormalTok{(}\VariableTok{TRAIN\_class\_labels}\NormalTok{)))}\OperatorTok{,} \SpecialStringTok{\textquotesingle{} classes.\textquotesingle{}}\NormalTok{])}\OperatorTok{;}
\VariableTok{disp}\NormalTok{([}\SpecialStringTok{\textquotesingle{}The training set is of size \textquotesingle{}}\OperatorTok{,} \VariableTok{int2str}\NormalTok{(}\VariableTok{size}\NormalTok{(}\VariableTok{TRAIN}\OperatorTok{,}\FloatTok{1}\NormalTok{))}\OperatorTok{,}\SpecialStringTok{\textquotesingle{}.\textquotesingle{}}\NormalTok{])}\OperatorTok{;}
\VariableTok{disp}\NormalTok{([}\SpecialStringTok{\textquotesingle{}The time series are of length \textquotesingle{}}\OperatorTok{,} \VariableTok{int2str}\NormalTok{(}\VariableTok{size}\NormalTok{(}\VariableTok{TRAIN}\OperatorTok{,}\FloatTok{2}\NormalTok{))}\OperatorTok{,}\SpecialStringTok{\textquotesingle{}.\textquotesingle{}}\NormalTok{])}\OperatorTok{;}
\VariableTok{disp}\NormalTok{([}\SpecialStringTok{\textquotesingle{}The dataset\textquotesingle{}\textquotesingle{}s most common class is \textquotesingle{}}\OperatorTok{,}\VariableTok{num2str}\NormalTok{(}\VariableTok{class}\NormalTok{)}\OperatorTok{,}\SpecialStringTok{\textquotesingle{} with a total of \textquotesingle{}}\OperatorTok{,}\VariableTok{num2str}\NormalTok{(}\VariableTok{count}\NormalTok{)}\OperatorTok{,}\SpecialStringTok{\textquotesingle{} occurances.\textquotesingle{}}\NormalTok{])}\OperatorTok{;}
\VariableTok{disp}\NormalTok{([}\SpecialStringTok{\textquotesingle{}The default error rate is \textquotesingle{}}\OperatorTok{,}\VariableTok{num2str}\NormalTok{(}\VariableTok{default\_error\_rate}\NormalTok{)}\OperatorTok{,}\SpecialStringTok{\textquotesingle{}.\textquotesingle{}}\NormalTok{])}\OperatorTok{;}
\CommentTok{\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%}

\CommentTok{\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%}
\CommentTok{\% Compute and display the k{-}fold error rate}
\CommentTok{\%}
\VariableTok{k}\OperatorTok{=}\VariableTok{length}\NormalTok{(}\VariableTok{TRAIN\_class\_labels}\NormalTok{)}\OperatorTok{;}
\VariableTok{k\_fold\_error\_rate} \OperatorTok{=} \VariableTok{k\_fold\_cross\_validation}\NormalTok{(}\VariableTok{TRAIN}\OperatorTok{,}\VariableTok{TRAIN\_class\_labels}\OperatorTok{,}\VariableTok{k}\NormalTok{)}\OperatorTok{;}
\VariableTok{disp}\NormalTok{([}\SpecialStringTok{\textquotesingle{}The normal k{-}fold error rate is \textquotesingle{}}\OperatorTok{,}\VariableTok{num2str}\NormalTok{(}\VariableTok{k\_fold\_error\_rate}\NormalTok{)}\OperatorTok{,}\SpecialStringTok{\textquotesingle{} where k=\textquotesingle{}}\OperatorTok{,}\VariableTok{num2str}\NormalTok{(}\VariableTok{k}\NormalTok{)}\OperatorTok{,}\SpecialStringTok{\textquotesingle{} and length of train set is \textquotesingle{}}\OperatorTok{,}\VariableTok{num2str}\NormalTok{(}\VariableTok{length}\NormalTok{(}\VariableTok{TRAIN\_class\_labels}\NormalTok{))}\OperatorTok{,}\SpecialStringTok{\textquotesingle{}.\textquotesingle{}}\NormalTok{])}\OperatorTok{;}
\CommentTok{\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%}
...
\CommentTok{\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%\%}
\KeywordTok{function} \VariableTok{predicted\_class} \OperatorTok{=} \VariableTok{Classification\_Algorithm}\NormalTok{(}\VariableTok{TRAIN}\OperatorTok{,}\VariableTok{TRAIN\_class\_labels}\OperatorTok{,}\VariableTok{unknown\_object}\NormalTok{)}
\VariableTok{best\_so\_far} \OperatorTok{=} \VariableTok{inf}\OperatorTok{;}
\KeywordTok{for} \VariableTok{i} \OperatorTok{=} \FloatTok{1} \OperatorTok{:} \VariableTok{length}\NormalTok{(}\VariableTok{TRAIN\_class\_labels}\NormalTok{)}
    \VariableTok{compare\_to\_this\_object} \OperatorTok{=} \VariableTok{TRAIN}\NormalTok{(}\VariableTok{i}\OperatorTok{,:}\NormalTok{)}\OperatorTok{;}
    \VariableTok{distance} \OperatorTok{=} \VariableTok{sqrt}\NormalTok{(}\VariableTok{sum}\NormalTok{((}\VariableTok{compare\_to\_this\_object} \OperatorTok{{-}} \VariableTok{unknown\_object}\NormalTok{)}\OperatorTok{.\^{}}\FloatTok{2}\NormalTok{))}\OperatorTok{;} \CommentTok{\% Euclidean distance}
    \KeywordTok{if} \VariableTok{distance} \OperatorTok{\textless{}} \VariableTok{best\_so\_far}
        \VariableTok{predicted\_class} \OperatorTok{=} \VariableTok{TRAIN\_class\_labels}\NormalTok{(}\VariableTok{i}\NormalTok{)}\OperatorTok{;}
        \VariableTok{best\_so\_far} \OperatorTok{=} \VariableTok{distance}\OperatorTok{;}
    \KeywordTok{end}
