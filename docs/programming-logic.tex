...
We've already been using examples of functions in our psuedocode - such as when we would include the \texttt{write} statement - and formal functions, such as the \texttt{print}, \texttt{count}, or \texttt{echo} statements we saw in the conditional examples at the end of the previous chapter.
