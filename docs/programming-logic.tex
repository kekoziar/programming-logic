...
The data in all cells (or elements) of an array needs to be the same type, which is part of what makes an array different than a list. Most computer languages will automatically convert integers to floats, but not the other way around.

You may also see this data structure called a \textbf{vector}.
...
Let's look at an example the following dataframe, which is created using two \texttt{for} loops
...
The pseudocode for how this dataframe was created is as follows:
