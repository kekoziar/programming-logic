...
at the top of your paper, write out the \texttt{ingredients} assignment. On the line below that we're going to create create headers for all of the variables used within the for loop code block. Starting on the left going right, write the term \texttt{loop\ iteration}, then \texttt{ingredient} in the center of the line, then the term \texttt{write} on the right of the line.
