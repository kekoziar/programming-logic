...
\item
  \texttt{ALLCAPS} means someting specific in certain languages, such as constants in C/C++. it can be used, but you should avoid it.
\end{itemize}
...
Here are some common issues that we've seen during consultations. We've covered some of these prior in the workshop.
